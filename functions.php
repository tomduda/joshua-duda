...
/* Make theme available for translation. */
	...
	add_theme_support( 'custom-background', apply_filters( 'joshua_custom_background_args',                array('default-color' => 'b2b2b2',
...
function joshua_widgets_init() {
	register_sidebar( array('name' => __( 'Sidebar', 'joshua' ),
		                    'id'   => 'sidebar-1',
    ...
    register_sidebar( array('name' => __( 'Footer Widgets', 'joshua' ),
